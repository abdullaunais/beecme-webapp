...
import { NavItem, NavItemType } from '../../beans';
...
export class AdminLayoutComponent implements OnInit, AfterViewInit {
  ...
  isMac(): boolean {
    let bool = false;
    if (navigator.platform.toUpperCase().indexOf('MAC') >= 0 ||navigator.platform.toUpperCase().indexOf('LINUX') >= 0 || navigator.platform.toUpperCase().indexOf('IPAD') >= 0) {
      bool = true;
    }
    return bool;
  }
